...
int main() {
    ...
    network<std::string,double> layer1 = set_layer_1();
    //layer_info(layer1);
...
//    std::cout << "测试LPA算法...\n";
//    LPA<std::string,double> lpa1(layer1);
...
//    show_community_result(community);
    ...
    std::vector<std::set<std::string>> community = graphProcess.CurrentIterationCommunities(1,overlap_rate);
